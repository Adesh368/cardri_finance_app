...
class BvnUserInputScreen extends StatefulWidget {
  const BvnUserInputScreen({super.key});

  @override
  State<BvnUserInputScreen> createState() => _BvnUserInputScreenState();
}

class _BvnUserInputScreenState extends State<BvnUserInputScreen> {
                ...
                Padding(
                  ...
                  child: Stack(children: [
                    Column(
                        ...
                        if(errorMessage)
                        const ErrorMessageWidget(errortext: '', erroeimage2: '', erroeimage1: '')
                  ]),
                ),
